        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="bradcam_text">
                    ...
                    <h5 style="color: white;">Segala Pengumuman & Informasi Mengenai KSP Artha Jaya Buana</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section_title text-center mb-90">
                    ...
                    <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Koperasi Simpan Pinjam Artha Jaya Buana</p>
                </div>
            </div>
        </div>
        <div class="row">
